...
@Database(
    entities = [ProductEntity::class, CategoriesEntity::class, SubcategoryEntity::class, ProductListingEntity::class, StoreEntity::class],
    version = 4 /*This means the number of changes in the database schema so every time you make a change of the structure
