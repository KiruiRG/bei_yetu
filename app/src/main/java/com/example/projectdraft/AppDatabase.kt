...
@Database(
    entities = [ProductEntity::class, CategoriesEntity::class, SubcategoryEntity::class],
    version = 3 /*This means the number of changes in the database schema so every time you make a change of the structure
