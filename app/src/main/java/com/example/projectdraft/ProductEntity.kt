...
@Entity(
    ...
    foreignKeys = [
        ForeignKey(
            ...
            childColumns = ["subcategoryId"],//The column in the products entity that needs the id
...
data class ProductEntity(
    ...
    val name: String,
    val subcategoryId: Int, // foreign key to SubcategoryEntity
    val price: Double,
    val imageRes: Int, // optional – drawable resource
    val description: String? = null // make nullable for flexibility
)
...
data class ProductWithCategoryAndSubcategory(
    val id: Int,
    val name: String,
    val price: Double,
    val imageRes: Int,
